...
$lang = array_merge($lang, array(
	...
	'PTT_ADD_TAGS_DONE'			=> '<strong>%1$s</strong> added, <strong>%2$s</strong> not added. Tags are not added if they are not unique',
	...
	'PTT_NOT_REPLY'				=> 'Please, note this is NOT a quick reply box, this is used for tagging posts. Click to enable',
	...
	'PTT_ACP_RESULTS_DESC'			=> 'To remove a tag associated with a topic click the tag in the table below. To view the topic you can clikc the topic\'s title',
	...
	'PTT_ACP_MIN_SIZE_EXPLAIN'		=> 'The minimum size of the fonts in the tag clouds',
	'PTT_ACP_MAX_SIZE'				=> 'Maximum font size',
	'PTT_ACP_MAX_SIZE_EXPLAIN'		=> 'The maximum size of the fonts in the tag clouds',
	...
	'TOO_SMALL_PTT_MIN_FONT'		=> 'The minimum font size is too small. Must be greater than 0',
